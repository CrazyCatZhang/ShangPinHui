            ...
            <div class="mainCon">
                ...
                <div class="InfoWrap">
                    <div class="goodsDetail">
                        <h3 class="InfoName">{{ detailInfo.skuInfo?.skuName }}</h3>
                        <p class="news">{{ detailInfo.skuInfo?.skuDesc }}</p>
                        <div class="priceArea">
                            <div class="priceArea1">
                                <div class="title">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格</div>
                                <div class="price">
                                    <i>¥ </i>
                                    <em>{{ detailInfo.skuInfo?.price }}</em>
                                    <span>降价通知</span>
                                </div>
                                <div class="remark">
                                    <i>累计评价</i>
                                    <em>{{ detailInfo.skuInfo?.id ** 2 }}</em>
                                </div>
                            </div>
                            <div class="priceArea2">
                                ...
                                <div class="fixWidth">
                                    ...
                                    <em class="t-gray"> {{ detailInfo.skuInfo?.createTime }}</em>
                                </div>
                            </div>
                        </div>
                        <div class="support">
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="saleAttr of detailInfo.spuSaleAttrList" :key="saleAttr.id">
                                <dt class="title">{{ saleAttr.saleAttrName }}</dt>
                                <dd changepirce="0" :class="{active: saleAttrValue.isChecked === '1'}"
                                    v-for="saleAttrValue of saleAttr.spuSaleAttrValueList" :key="saleAttrValue.id"
                        ...
                        <div class="cartWrap">
                            <div class="controls">
                                <input autocomplete="off" class="itxt" v-model="skuNum" @change="handle">
