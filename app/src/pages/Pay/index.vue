...
export default {
    ...
    mounted() {
        this.$store.dispatch('pay/getPayInfo', this.orderId)
    },
    computed: {
    ...
    methods: {
        async open() {
            this.timer = setInterval(async () => {
                const result = await this.$store.dispatch('pay/getPayResult', this.orderId)
            ...
            await this.$alert(`<img src=${url} />`, "请你微信扫码支付", {
                ...
                this.$message.error('支付失败，支付遇到问题请联系管理')
            })
        }
    },
}
